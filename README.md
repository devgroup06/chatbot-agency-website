...
Branded marketing website for the AI Chatbot Agency product (multi-tenant AI chatbots for WhatsApp, Facebook Messenger, Instagram DM and websites), live at **https://dialoghive.com**.
...
- **Auto deploy** — every push to `main` that touches `website/` builds the static site and FTP-deploys it to Hostinger (dialoghive.com)
